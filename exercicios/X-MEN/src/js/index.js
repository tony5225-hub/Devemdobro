...
personagens.forEach ((personagem) =>{
    personagem.addEventListener('mouseenter',() =>{
        ...
        removerSelecaoDoPersonagem(); // aqui foi criado função se clicar f12 ele vai mostrar emabixo essa função, que é feito selecionando os dizeres com direito mouse/refatorar / dar a função global.
        ...
        alterarImagemPersonagemSelecionado(personagem); // aqui foi criado função se clicar f12 ele vai mostrar emabixo essa função, que é feito selecionando os dizeres com direito mouse/refatorar / dar a função global.
